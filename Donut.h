...
//further documentation / information in Donut.cpp
...
public:
  Donut(); //default constructor
  ~Donut(); //default destructor
  char** makeDonutArr(char** curr, int w, int h); //turns curr into mirrored array
